# VideoCompress
A Telegram Video Compressor Bot By [@VKPROJECTS](https://t.me/VKPROJECTS). **This bot works for all!** No need to define each user IDs to use bot. Also works in Group.
